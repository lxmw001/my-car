	...
	<Page>
		<FlexboxLayout class="page">
			<StackLayout class="form">
				<Image class="logo" src="~/assets/images/car-logo.png" />
				<Label class="header" text="My Car" />
  ...
  methods: {
    ...
    forgotPassword() {
      prompt({
        ...
        message:
          "Enter the email address you used to register for My Car to reset your password.",
        inputType: "email",
        defaultText: "",
        okButtonText: "Ok",
